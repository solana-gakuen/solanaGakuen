        ...
        <Grid container
            ...
            <div>
                ...
                <ParallaxBanner
                    ...
                    style={{ aspectRatio: '2 / 1', height: "250vh", opacity: "0.6" }}
                />
            </span>
            </div>
            ...
            <Grid direction="column" sx={{
                ...
                <List
                    sx={{width: '80%', backgroundColor: "#f6b0bb", borderRadius: "25px", margin: "auto"}}
                    component="nav"
                    aria-labelledby="nested-list-subheader"
                >
                    <ListItemButton onClick={()=>handle_click_faq("1")} >
                        <ListItemText>
                            <div style={{fontSize: "0.5em",textShadow: "2px 2px 5px #8c6068"}}>What Is Solana Gakuen Aim For? Why so special?</div>
                        </ListItemText>
                        ...
                        <List component="div" disablePadding>
                            <ListItemButton >
                                <ListItemText sx={{  backgroundColor: "#ffcccc", borderRadius: "25px", padding:"0"}} >
                                    <p style={{padding: "0 5% 0 5%", textAlign: "justify", fontSize: "0.3em", textShadow: "2px 2px 5px #8c6068"}}>Solana Gakuen is a long term project. It aims for building a school simulation universe while acting as a bridge between the anime industry and the crypto world.</p>

                                    <p style={{padding: "0 5% 0 5%", textAlign: "justify", fontSize: "0.3em", textShadow: "2px 2px 5px #8c6068"}}>
                    ...
                    <ListItemButton onClick={()=>handle_click_faq("2")}>
                        <ListItemText>
                            <div style={{fontSize: "0.5em", textShadow: "2px 2px 5px #8c6068"}}>What is doujin and why?</div>
                        </ListItemText>
                    ...
                    <ListItemButton onClick={()=>handle_click_faq("3")}>
                        <ListItemText>
                            <div style={{fontSize: "0.5em", textShadow: "2px 2px 5px #8c6068"}}>What is the meaning of cross chain Gakuen?</div>
                        </ListItemText>
